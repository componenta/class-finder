...
$loader->addPsr4('Componenta\\Stdlib\\', $packages . '/iterator/src', true);
$loader->setPsr4('Componenta\\ClassFinder\\', $package . '/src');
$loader->setPsr4('Componenta\\ClassFinder\\Tests\\', __DIR__);
